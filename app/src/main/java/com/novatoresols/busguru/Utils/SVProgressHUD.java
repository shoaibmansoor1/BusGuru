...
/**
 * Created by macbookpor on 27/08/2016.
 */
...
public class SVProgressHUD {
    ...
    public static void showInView(Context context, String text, boolean networkIndicator) {
        ...
        if (!networkIndicator) {
            ...
            LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) progressBar1.getLayoutParams();
            params.height = 0;
            progressBar1.setLayoutParams(params);
        } else {
            ProgressBar progressBar1 = (ProgressBar) static_waitLoadingView.findViewById(R.id.progressBar1);
            progressBar1.setVisibility(View.VISIBLE);
//            progressBar1.getIndeterminateDrawable().setColorFilter(Color.parseColor("#cbfefa"), PorterDuff.Mode.LIGHTEN);
            LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) progressBar1.getLayoutParams();
